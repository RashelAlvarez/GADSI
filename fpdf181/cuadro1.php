...
function Header()
{
	...
	//Salto de línea*/
							  //0,1 --> (el 0 es el borde, si le pones 1 se coloca), y (el 1 es siguiente linea).
	$this->cell(100,8,'REPORTE',0,1,'C');
	$this->Ln(10);
	// enca
...
//include('../config/conexi.php');
			  	...
			  	// para el paginador
					...
					$pdf->Cell(20,7,'Cliente',0,0,'C',true);
					$pdf->Cell(20,7,'Estatus',0,0,'C',true);
					$pdf->Cell(40,7,'N. Actividades Pendientes',0,0,'C',true);
					$pdf->Cell(47,7,'Horas de Presupuesto',0,0,'C',true);
					$pdf->Cell(23,7,'Presupuesto',0,1,'C',true);
...
// UTILIZAR substr($row['ne'],0,40), EL 40 SIGNIFICA 40 CARACTERES MAXIMO, el $row te traes la variable de la BD.
                                    //40 de ancho, 10 de alto. 'C' de centrar.
						//$pdf->Cell(40,10,substr($row['nombre'],0,30),0,0,'C');
						//$pdf->Cell(20,10,$row['cliente'],0,0,'C');
						//$pdf->Cell(20,10,$row['estatus'],0,0,'C');
						//$pdf->Cell(40,10,$row['actividadesPendiente'],0,0,'C');
						//$pdf->Cell(47,10,$row['horasPresupuesto'],0,0,'C');
													//termina en 1,1 para continuar abajo.
						//$pdf->Cell(23,10,($row['presupuesto']),1,1,'C');
